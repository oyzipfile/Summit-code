...
public final class RaycastUtils extends MinecraftInstance
{
    ...
    private static Entity raycastEntity(final double range, final float yaw, final float pitch, final IEntityFilter entityFilter) {
        ...
        if (renderViewEntity != null && RaycastUtils.mc.world != null) {
            ...
            final List<Entity> entityList = (List<Entity>)RaycastUtils.mc.world.getEntitiesInAABBexcluding(renderViewEntity, renderViewEntity.getEntityBoundingBox().expand(entityLook.x * blockReachDistance, entityLook.y * blockReachDistance, entityLook.z * blockReachDistance).expand(1.0, 1.0, 1.0), Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::func_70067_L));
