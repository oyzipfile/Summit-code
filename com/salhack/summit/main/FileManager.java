...
import com.salhack.summit.gui.altmanager.Alt;
import com.salhack.summit.gui.altmanager.Manager;
...
public class FileManager
{
    ...
    public FileManager() {
        try {
            this.salDir = new File(DirectoryManager.Get().GetCurrentDirectory() + File.separator + "Summit");
