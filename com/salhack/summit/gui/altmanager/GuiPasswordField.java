...
public class GuiPasswordField extends Gui
{
    ...
    public void setResponderEntryValue(final int p_190516_1_, final String p_190516_2_) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                j2 = this.fontRendererInstance.drawStringWithShadow(s2.replaceAll("(?s).", "*"), (float)l, (float)i2, i);
            }
