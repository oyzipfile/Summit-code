...
public class ImageManager
{
    ...
    public void LoadImage(final String p_Img) {
        ...
        final InputStream l_Stream = ImageManager.class.getResourceAsStream("/assets/salhack/imgs/" + p_Img + ".png");
        try {
        ...
        if (l_Texture != null) {
            l_Texture.SetResourceLocation(Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("salhack/textures", (DynamicTexture)l_Texture));
