...
public class MacroManager
{
    ...
    public void Load() {
        try {
            final File files = new File(DirectoryManager.Get().GetCurrentDirectory() + "/Summit/Macros/");
    ...
    private void save() {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        com/salhack/summit/managers/MacroManager.macros:Ljava/util/HashMap;
