                    ...
                    public void run() {
                        ...
                        if (shulkerNBT != null) {
                            ...
                            if (ShulkerPreview.this.SavedShulkerItems.containsKey(customName)) {
                                ...
                                Summit.SendMessage("New shulker found with name " + customName + " it contains " + l_SlotsNotEmpty + " slots NOT empty");
                            }
        ...
        this.OnRenderTooltip = new Listener<EventRenderTooltip>(p_Event -> {
            if (p_Event.getItemStack() == null) {
                ...
                if (Item.getIdFromItem(p_Event.getItemStack().getItem()) == 130) {
                    ...
                    RenderUtil.drawStringWithShadow("Summit EnderChest Viewer", 0.0f, (float)(-mc.fontRenderer.FONT_HEIGHT - 1), -1);
                    ...
                    if (this.middleClick.getValue()) {
                        if (Mouse.isButtonDown(2)) {
                            if (!this.clicked) {
                                l_Inventory = new InventoryBasic("Summit EnderChest Viewer", true, 27);
