...
import com.salhack.summit.util.HilbertCurve;
...
public class StashFinder extends Module
{
    ...
    public StashFinder() {
        ...
        this.OnPlayerUpdate = new Listener<EventPlayerUpdate>(event -> {
            if (!this.automaticWalk.getValue() && !SummitStatic.AUTOARMOR.isEnabled() && SummitStatic.AUTOWALK.isEnabled()) {
                SummitStatic.AUTOWALK.toggle();
            }
            if (this.automaticWalk.getValue() && !SummitStatic.AUTOARMOR.isEnabled()) {
                SummitStatic.AUTOARMOR.toggle();
            }
            if (SummitStatic.AUTOARMOR.isEnabled() && !this.automaticWalk.getValue()) {
                SummitStatic.AUTOARMOR.toggle();
            }
    ...
    public void onEnable() {
        ...
        if (!this.automaticWalk.getValue() && SummitStatic.AUTOWALK.isEnabled()) {
            SummitStatic.AUTOWALK.toggle();
        }
        super.onEnable();
        this.WaypointPath.clear();
        ...
        if (this.ToggleLog.getValue() && !SummitStatic.STASHLOGGER.isEnabled()) {
            SummitStatic.STASHLOGGER.toggle();
        }
