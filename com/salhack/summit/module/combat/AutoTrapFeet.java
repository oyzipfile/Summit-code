...
public class AutoTrapFeet extends Module
{
                ...
                if (this.Target != null) {
                    if (this.IsCurrentTargetTrapped()) {
                        if (this.Toggles.getValue()) {
                            this.toggle();
                            Summit.SendMessage(ChatFormatting.LIGHT_PURPLE + "[AutoTrapFeet]: Current target is trapped. Toggling");
                        }
                    }
    ...
    public void onEnable() {
        ...
        if (this.Target != null) {
            Summit.SendMessage("[AutoTrapFeet]: Found target " + this.Target.getName());
        }
    }
